...
public class ClientProcessor extends AbstractModelVariableModifierProcessor {

	@Autowired
	private ClientService clientService;
	
	public ClientProcessor(String elementName) {
		super(elementName);
	}
	...
	protected void modifyModelAttributes(Arguments arguments, Element element) {
		...
		{
			result = clientService.find(Long.valueOf(idStr));
		}
