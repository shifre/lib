package com.cantonsoft.admin.client.notice;
...
@Access(value = "fn.client.notice")
public class ClientNoticeApi extends BaseEntityApi<Notice, Long, Notice, Notice>{
	@Autowired
	...
	protected PageData<Notice> doSearch(PageFilter filter, HttpServletRequest request, HttpServletResponse response) {
		filter.getConds().add(new Cond("type", Cond.OP_EQ, String.valueOf(2)));
