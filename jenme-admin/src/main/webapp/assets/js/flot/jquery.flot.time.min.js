...
(function($) {
	...
	function dateGenerator(ts, opts) {
		...
		} else if (typeof timezoneJS != "undefined"
	...
	var baseSpec = [ [ 1, "second" ], [ 2, "second" ], [ 5, "second" ],
			...
			[ 3, "day" ], [ .25, "month" ], [ .5, "month" ], [ 1, "month" ],
			[ 2, "month" ] ];
										...
										if (opts.mode == "time") {
											axis.tickGenerator = function(axis) {
												...
												var spec = opts.tickSize
														&& opts.tickSize[1] === "quarter"
														|| opts.minTickSize
														&& opts.minTickSize[1] === "quarter" ? specQuarters
														: specMonths;
												...
												if (unit == "second") {
													...
													d.setMinutes(floorInBase(d
															.getMinutes(),
															tickSize))
												} else if (unit == "hour") {
													d.setHours(floorInBase(d
															.getHours(),
															tickSize))
												} else if (unit == "month") {
